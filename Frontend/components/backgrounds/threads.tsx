...
/**
 * Threads — animated WebGL line-field background.
 * Used exclusively on the landing page hero. Colors default to
 * white/platinum per the frozen design system (no purple).
 */
